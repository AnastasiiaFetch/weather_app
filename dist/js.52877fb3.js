...
exports.Axios = Axios;
},{"./lib/axios.js":"../node_modules/axios/lib/axios.js"}],"js/modules/getWeather.ts":[function(require,module,exports) {
"use strict";
...
var weatherApiKey = "d116a07df720471cb11111225231204";
function getWeather(city) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          request = "http://api.weatherapi.com/v1/forecast.json?key=".concat(weatherApiKey, "&q=").concat(city, "&days=1&aqi=no&alerts=no");
          _a.label = 1;
        case 1:
          _a.trys.push([1, 3,, 4]);
          return [4 /*yield*/, axios_1.default.get(request)];
        case 2:
          response = _a.sent();
        ...
        case 3:
          error_1 = _a.sent();
          if (error_1.response) {
            alert(error_1.response.data.error.message);
          }
          return [3 /*break*/, 4];
        case 4:
          return [2 /*return*/];
...
},{"axios":"../node_modules/axios/index.js"}],"js/modules/showForecast.ts":[function(require,module,exports) {
"use strict";
...
var showForecast = function showForecast(forecast) {
  var timeWeatherArray = forecast.forecastday[0].hour;
  var dayWeather = forecast.forecastday[0].day;
  var currentTime = getDate();
  var cards = "";
  timeWeatherArray.forEach(function (element) {
    if (element.time.slice(-5) >= currentTime) {
      cards += "\n      <div class=\"forecast_card\">\n        <div>\n          Time: \n          <span>".concat(element.time.slice(-5), "</span>\n        </div>\n        <div>\n          Temperature: \n          <span>").concat(element.temp_c, "\xB0C</span>\n        </div>\n        <div>\n          <img src=\"").concat(element.condition.icon, "\" alt=\"weather_icon\">\n        </div>\n        <div>\n          <span>").concat(element.condition.text, "</span>\n        </div>\n      </div>\n      ");
    }
  });
  var html = "\n  <div class=\"forecast_section_wrapper\">\n     <div class=\"forecast_section_header\">\n      <div>Max Temperature: \n        <span>".concat(dayWeather.maxtemp_c, "\xB0C</span>\n      </div>\n      <div>Min Temperature: \n        <span>").concat(dayWeather.mintemp_c, "\xB0C</span>\n      </div>\n      <div>Chances of Rain: \n        <span>").concat(dayWeather.daily_chance_of_rain, "%</span>\n      </div>\n    </div>\n    <div class=\"forecast_section_cards\">").concat(cards, "</div>\n  </div>\n  ");
  document.querySelector("#outputForecast").innerHTML = html;
};
exports.default = showForecast;
},{}],"js/modules/showInfo.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var showInfo = function showInfo(_a) {
  var location = _a.location,
    current = _a.current;
  var html = "\n      <div class=\"main_info_wrapper\">\n        <div class=\"location_info_wrapper\">\n          <div class=\"location_title\">City: <span>".concat(location.name, "</span></div>\n          <div class=\"location_details\">\n            <p>Region: <span>").concat(location.region, "</span></p>\n            <p>Country: <span>").concat(location.country, "</span></p>\n            <p>Local Time: <span>").concat(location.localtime, "</span></p>\n          </div>\n        </div>\n\n        <div class=\"condition_info_wrapper\">\n          <div class=\"condition_img\">\n            <img src=\"").concat(current.condition.icon, "\" alt=\"weather_icon\">\n          </div>\n          <div class=\"condition_desc\">").concat(current.condition.text, "</div>\n        </div>\n      </div>\n\n      <div class=\"detailed_info_wrapper\">\n        <p>Temperature: <span>").concat(current.temp_c, "\xB0C</span></p>\n        <p>Feels like: <span>").concat(current.feelslike_c, "\xB0C</span></p>\n        <p>Wind Speed: <span>").concat(current.wind_mph, " mph</span></p>\n        <p>Cloud: <span>").concat(current.cloud, "%</span></p>\n        <p>Humidity: <span>").concat(current.humidity, "%</span></p>\n      </div>\n    ");
...
var getWeather_1 = __importDefault(require("./modules/getWeather"));
var showForecast_1 = __importDefault(require("./modules/showForecast"));
var showInfo_1 = __importDefault(require("./modules/showInfo"));
var formElement = document.querySelector("#form");
var homePage = document.querySelector(".main_page_wrapper");
var infoPage = document.querySelector("section:last-child");
var homePageIcon = document.querySelector("main > section:first-of-type > div");
...
formElement.addEventListener("submit", function (event) {
  return __awaiter(void 0, void 0, void 0, function () {
    var formData, city, data, location, current, forecast;
    var _a;
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          city = (_a = formData.get("city")) === null || _a === void 0 ? void 0 : _a.toString().trim();
          if (!city) return [2 /*return*/];
          return [4 /*yield*/, (0, getWeather_1.default)(city)];
        case 1:
          data = _b.sent();
          if (data) {
            homePage.style.display = "none";
            infoPage.style.display = "flex";
            location = data.location, current = data.current, forecast = data.forecast;
            (0, showInfo_1.default)({
              location: location,
              current: current
            });
            (0, showForecast_1.default)(forecast);
...
},{"./modules/getWeather":"js/modules/getWeather.ts","./modules/showForecast":"js/modules/showForecast.ts","./modules/showInfo":"js/modules/showInfo.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
